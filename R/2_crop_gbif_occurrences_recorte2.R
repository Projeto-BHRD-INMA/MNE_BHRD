...
###                 09 feb 2021    updated: 01 jun 2022                      ###
###                                                                          ###
################################################################################
...
library(data.table)
#?fread
spp.table <- fread("./data/registros/spp_2022/2_Gbif_occ_recorte2.csv")
...
write.csv(spp.shp.ame, "./data/registros/spp_2022/3_Gbif_occ_recorte2_amesul.csv")
